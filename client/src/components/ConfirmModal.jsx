                ...
                >
                    <div className="p-6">
                        ...
                        <div className="flex gap-3">
                            <button
                                onClick={onClose}
                                className="flex-1 px-4 py-3 rounded-xl text-sm font-semibold text-gray-600 dark:text-gray-400 bg-gray-50 dark:bg-gray-950 hover:bg-gray-100 dark:hover:bg-gray-700 transition-all active:scale-[0.98]"
                            >
                                {cancelText}
                            </button>
                            <button
