...
const Step2License = ({ formData, updateField, nextStep, prevStep }) => {
    ...
    return (
        <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-6 sm:p-8">
            <div className="mb-6">
                <h2 className="text-xl font-bold text-gray-900">Driving License Details</h2>
                <p className="text-sm text-gray-500 mt-1">Provide your license information for verification</p>
            </div>
            ...
            <div className="space-y-5">
                ...
                <div>
                    ...
                    <div className="relative">
                        ...
                        <input
                            ...
                            className={`w-full pl-10 pr-4 py-3 bg-gray-50 border rounded-xl focus:ring-2 focus:ring-teal-500 focus:border-transparent focus:bg-white text-gray-900 placeholder-gray-400 text-sm transition-all outline-none ${errors.licenseNumber ? 'border-red-300' : 'border-gray-200'}`}
                        />
                    </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div>
                        ...
                        <div className="relative">
                            <FiCalendar className="absolute left-3.5 top-3.5 text-gray-400" size={16} />
                            <input
                                type="date"
                                value={formData.dateOfBirth}
                                onChange={(e) => updateField('dateOfBirth', e.target.value)}
                                className={`w-full pl-10 pr-4 py-3 bg-gray-50 border rounded-xl focus:ring-2 focus:ring-teal-500 focus:border-transparent focus:bg-white text-gray-900 text-sm transition-all outline-none ${errors.dateOfBirth ? 'border-red-300' : 'border-gray-200'}`}
                            />
                        </div>
                    ...
                    <div>
                        ...
                        <div className="relative">
                            ...
                            <input
                                ...
                                className={`w-full pl-10 pr-4 py-3 bg-gray-50 border rounded-xl focus:ring-2 focus:ring-teal-500 focus:border-transparent focus:bg-white text-gray-900 text-sm transition-all outline-none ${errors.licenseExpiry ? 'border-red-300' : 'border-gray-200'}`}
                            />
                        </div>
                ...
                <div>
                    <label className="block text-sm font-medium text-gray-700 mb-1.5">Upload License Image</label>
                    {formData.licenseImage ? (
                        <div className="relative rounded-xl overflow-hidden border border-gray-200 bg-gray-50">
                            <img src={formData.licenseImage} alt="License" className="w-full h-48 object-contain bg-white" />
                            <button
