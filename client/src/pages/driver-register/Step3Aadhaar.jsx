...
const Step3Aadhaar = ({ formData, updateField, nextStep, prevStep }) => {
    ...
    return (
        <div className="bg-white dark:bg-gray-900 rounded-2xl shadow-sm border border-gray-200 dark:border-gray-700 p-6 sm:p-8">
            <div className="mb-6">
                <h2 className="text-xl font-bold text-gray-900 dark:text-white">Upload your Aadhaar Card</h2>
            ...
            <div className="flex items-start gap-3 bg-teal-50 dark:bg-teal-900/20 border border-teal-100 rounded-xl p-4 mb-6">
                <FiShield className="text-teal-600 dark:text-teal-400 shrink-0 mt-0.5" size={18} />
                <div>
                    <p className="text-sm font-medium text-teal-800">Your privacy is important</p>
                    <p className="text-xs text-teal-600 dark:text-teal-400 mt-0.5">Your Aadhaar details are encrypted and only accessible to verified admins during the review process.</p>
                </div>
            </div>
            ...
            <div className="space-y-5">
                {/* Aadhaar Number */}
                <div>
                    <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1.5">Aadhaar Number *</label>
                ...
                <div>
                    <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1.5">Upload Aadhaar Image</label>
                    {formData.aadhaarImage ? (
                        <div className="relative rounded-xl overflow-hidden border border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-950">
                            <img src={formData.aadhaarImage} alt="Aadhaar" className="w-full h-48 object-contain bg-white dark:bg-gray-900" />
                            <button
                        ...
                        <label className="flex flex-col items-center justify-center w-full h-40 border-2 border-dashed border-gray-300 dark:border-gray-600 rounded-xl cursor-pointer hover:border-teal-400 hover:bg-teal-50 dark:bg-teal-900/20 transition-all">
                            ...
                            <span className="text-sm text-gray-500 dark:text-gray-400">Click to upload Aadhaar</span>
