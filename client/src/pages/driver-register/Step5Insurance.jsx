...
const Step5Insurance = ({ formData, updateField, nextStep, prevStep }) => {
        ...
        <div>
            ...
            {formData[field] ? (
                <div className="relative rounded-xl overflow-hidden border border-gray-200 bg-gray-50">
                    <img src={formData[field]} alt={label} className="w-full h-36 object-contain bg-white" />
                    <button
                ...
                <label className="flex flex-col items-center justify-center w-full h-32 border-2 border-dashed border-gray-300 rounded-xl cursor-pointer hover:border-teal-400 hover:bg-teal-50/50 transition-all">
                    <FiUpload size={20} className="text-gray-400 mb-1.5" />
                    <span className="text-sm text-gray-500">Upload document</span>
                    <span className="text-xs text-gray-400 mt-0.5">PNG, JPG, PDF up to 5MB</span>
    ...
    return (
        <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-6 sm:p-8">
            <div className="mb-6">
                <h2 className="text-xl font-bold text-gray-900">Insurance & RC Details</h2>
                <p className="text-sm text-gray-500 mt-1">Upload your insurance and registration certificate</p>
            </div>
            ...
            <div className="space-y-5">
                ...
                <div className="p-4 bg-gray-50 rounded-xl border border-gray-100">
                    <h3 className="text-sm font-semibold text-gray-800 mb-3">Insurance</h3>
                            ...
                            <div>
                                ...
                                <div className="relative">
                                    ...
                                    <input
                                        ...
                                        className="w-full pl-10 pr-4 py-3 bg-white border border-gray-200 rounded-xl focus:ring-2 focus:ring-teal-500 focus:border-transparent text-gray-900 placeholder-gray-400 text-sm transition-all outline-none"
                                    />
                                </div>
                            </div>
                            <div>
                                ...
                                <div className="relative">
                                    ...
                                    <input
                                        ...
                                        className="w-full pl-10 pr-4 py-3 bg-white border border-gray-200 rounded-xl focus:ring-2 focus:ring-teal-500 focus:border-transparent text-gray-900 text-sm transition-all outline-none"
                                    />
                                </div>
                            </div>
                        </div>
                ...
                {/* RC Section */}
                <div className="p-4 bg-gray-50 rounded-xl border border-gray-100">
                    <h3 className="text-sm font-semibold text-gray-800 mb-3">Registration Certificate (RC)</h3>
                    <div className="space-y-4">
                        <div>
