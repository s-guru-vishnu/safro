                ...
                >
                    ...
                    <div className="pt-12 px-6 pb-6">
                        ...
                        <div className="mb-5">
                            ...
                            <span className="inline-flex items-center gap-1 px-2.5 py-0.5 mt-1 bg-teal-50 dark:bg-teal-900/20 text-teal-600 dark:text-teal-400 text-xs font-semibold rounded-full capitalize">
                                        ...
                                        <>
                                            ...
                                            <div className="flex items-center gap-3 p-3 bg-gray-50 dark:bg-gray-950 rounded-xl">
                                                <div className="w-9 h-9 bg-white dark:bg-gray-900 rounded-lg flex items-center justify-center border border-gray-100 dark:border-gray-800">
                                                    <FiStar size={15} className="text-gray-400 dark:text-gray-500" />
                                                </div>
                                                <div>
                                                    <span className="text-[10px] text-gray-400 dark:text-gray-500 uppercase tracking-wider font-medium block">Rating</span>
                                            ...
                                            <div className="flex items-center gap-3 p-3 bg-gray-50 dark:bg-gray-950 rounded-xl">
                                                ...
                                                <div className="flex-1">
                                                    ...
                                                    <div className="flex items-center gap-2">
                                                        <span className={`text-sm font-bold ${driverData.negotiationScore < 40 ? 'text-red-600 dark:text-red-400' : driverData.negotiationScore < 60 ? 'text-amber-600' : 'text-teal-600 dark:text-teal-400'}`}>
