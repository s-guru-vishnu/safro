...
const SOS = () => {
    ...
    return (
        <div className="min-h-[calc(100vh-64px)] bg-gray-50 dark:bg-gray-950 flex items-center justify-center py-8">
            <div className="max-w-sm w-full mx-auto px-4">
                <motion.div
                    initial={{ opacity: 0, y: 20 }}
                    animate={{ opacity: 1, y: 0 }}
                    className="bg-white dark:bg-gray-900 rounded-2xl border border-gray-200 dark:border-gray-700 p-8 text-center"
                >
                    {/* Pulsing Icon */}
                    <div className="relative mx-auto w-20 h-20 mb-6">
                        ...
                        <div className="absolute inset-0 flex items-center justify-center">
                            <div className="w-14 h-14 bg-red-50 dark:bg-red-900/20 rounded-full flex items-center justify-center shadow-lg">
                                <FiAlertTriangle size={24} className="text-white" />
                            </div>
                        </div>
                    </div>

                    <h2 className="text-xl font-bold text-gray-900 dark:text-white mb-2">Emergency SOS</h2>
                    ...
                    <button
                        ...
                        className={`w-full py-4 rounded-xl font-bold text-sm transition-all ${sent
                            ? 'bg-green-50 dark:bg-green-900/20 text-white cursor-default'
                            : sending
                    ...
                    {sent && (
                        <motion.p
                            ...
                            animate={{ opacity: 1, y: 0 }}
                            className="mt-4 text-sm text-green-600 dark:text-green-400 bg-green-50 dark:bg-green-900/20 border border-green-100 rounded-xl p-3"
                        >
                ...
                <motion.div
                    ...
                    className="mt-5 bg-white dark:bg-gray-900 rounded-2xl border border-gray-200 dark:border-gray-700 p-5"
                >
                    <h3 className="text-sm font-bold text-gray-800 dark:text-gray-200 mb-3">Safety Tips</h3>
                    <div className="space-y-3">
                        {tips.map((tip, i) => (
                            <div key={i} className="flex items-center gap-3">
                                <div className="w-8 h-8 bg-gray-50 dark:bg-gray-950 rounded-lg flex items-center justify-center border border-gray-100 dark:border-gray-800">
                                    <tip.icon size={14} className="text-gray-400 dark:text-gray-500" />
                                </div>
